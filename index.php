        ...
        <div class="card-deck">
            <div class="card">
                <div class="face face1">
                    <div class="content">
                        <img src="готовая11.jpg" alt="BodyBlend Image" class="img-fluid rounded">
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Настоящее положение разработано с целью защиты информации, относящейся к персональным данным Пользователя, в соответствии с принципами, установленными:</p>
    ...
    <div class="modal fade" id="safetyRulesModal" tabindex="-1" role="dialog" aria-labelledby="safetyRulesModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: black;"><p>Правила и техника безопасности на тренажерах играют важную роль в предотвращении травм и обеспечении эффективной тренировки. Вот некоторые основные правила и рекомендации:</p>
                    <ul>
    ...
    <div class="modal fade" id="userAgreementModal" tabindex="-1" role="dialog" aria-labelledby="userAgreementModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: black;"><p>Пользовательское соглашение представляет собой документ, определяющий условия использования сайта или сервиса, которые пользователь должен принять, чтобы иметь доступ к предоставляемым функциям и возможностям. Ниже приведены основные положения пользовательского соглашения:</p>
                    <ol>
